      ...
      <Container>
        <Row style={{ display: "flex", justifyContent: "flex-start" }}>
          <Col xs={12} md={{ span: 6, offset: 6 }}>
            ...
            <Card
              style={{
                background: `${MAX_BLUE_OPAQUE}`,
                border: "none",
                padding: "1em",
                margin: "1em",
              }}
            >
              <h1 style={{ color: `${MAX_DARK}`, fontWeight: "bold" }}>
                Hi, I'm Max Manayan!
              </h1>
              ...
              <h5 style={{ color: `${MAX_DARK}` }}>
                ...
                learning the intricacies of computer systems and how data is
                managed throughout applications.
              </h5>
              {/* </Card> */}
              ...
              >
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.linkedin.com/in/maxmanayan/"
                >
                  <Image
                    style={{
                      width: "10em",
                      filter: "brightness(10em) opacity(90%)",
                      margin: "1em",
                    }}
                    src={linkedInLogo}
                  />
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/maxmanayan"
                >
                  <Image
                    style={{
                      width: "10em",
